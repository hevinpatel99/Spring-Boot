...
import com.jpa_audit.jwt.JwtAuthenticateFilter;
import com.jpa_audit.jwt.JwtAuthenticationEntryPoint;
...
public class JWTSecurityConfig {
    ...
    public JWTSecurityConfig(JwtAuthenticateFilter jwt, JwtAuthenticationEntryPoint authenticationEntryPoint, CustomUserDetailService userDetailService) {
        this.jwt = jwt;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/role/**", "/auth/**").permitAll();
